...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2014 at 03:53 PM
...
--
-- Table structure for table `yk_address`
--
...
--
-- Dumping data for table `yk_address`
--

INSERT INTO `yk_address` (`address_id`, `customer_id`, `firstname`, `lastname`, `company`, `company_id`, `tax_id`, `address_1`, `address_2`, `city`, `postcode`, `country_id`, `zone_id`) VALUES
(1, 1, 'anak', 'batam', 'Adam.Eve co', 'AE', '', 'tikam', 'tikam city', 'Batam', '29422', 100, 1529),
(2, 2, 'yogi', 'kortisa', '', '', '', 'tikam', '', 'batam', '', 100, 1529);

-- --------------------------------------------------------

--
-- Table structure for table `yk_affiliate`
--
...
--
-- Table structure for table `yk_affiliate_transaction`
--
...
--
-- Table structure for table `yk_attribute`
--
...
--
-- Dumping data for table `yk_attribute`
--
...
--
-- Table structure for table `yk_attribute_description`
--
...
--
-- Dumping data for table `yk_attribute_description`
--
...
--
-- Table structure for table `yk_attribute_group`
--
...
--
-- Dumping data for table `yk_attribute_group`
--
...
--
-- Table structure for table `yk_attribute_group_description`
--
...
--
-- Dumping data for table `yk_attribute_group_description`
--
...
--
-- Table structure for table `yk_banner`
--
...
--
-- Dumping data for table `yk_banner`
--
...
--
-- Table structure for table `yk_banner_image`
--
...
--
-- Dumping data for table `yk_banner_image`
--

INSERT INTO `yk_banner_image` (`banner_image_id`, `banner_id`, `link`, `image`) VALUES
(81, 7, 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'data/TEST/test.jpg'),
...
(78, 9, '/admin', 'data/TEST/da19b02cd8c0c7bdb972102604eeee11.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `yk_banner_image_description`
--
...
--
-- Table structure for table `yk_category`
--
...
--
-- Dumping data for table `yk_category`
--
...
--
-- Table structure for table `yk_category_description`
--
...
--
-- Dumping data for table `yk_category_description`
--
...
--
-- Table structure for table `yk_category_filter`
--
...
--
-- Table structure for table `yk_category_path`
--
...
--
-- Dumping data for table `yk_category_path`
--
...
--
-- Table structure for table `yk_category_to_layout`
--
...
--
-- Table structure for table `yk_category_to_store`
--
...
--
-- Dumping data for table `yk_category_to_store`
--
...
--
-- Table structure for table `yk_country`
--
...
--
-- Dumping data for table `yk_country`
--
...
--
-- Table structure for table `yk_coupon`
--
...
--
-- Dumping data for table `yk_coupon`
--
...
--
-- Table structure for table `yk_coupon_category`
--
...
--
-- Table structure for table `yk_coupon_history`
--
...
--
-- Table structure for table `yk_coupon_product`
--
...
--
-- Table structure for table `yk_currency`
--
...
--
-- Dumping data for table `yk_currency`
--

INSERT INTO `yk_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(2, 'US Dollar', 'USD', '$', '', '2', 0.00010000, 1, '2014-01-30 14:11:41'),
(4, 'Rupiah', 'IDR', 'Rp ', '', '', 1.00000000, 1, '2014-01-30 14:11:41');

-- --------------------------------------------------------

--
-- Table structure for table `yk_customer`
--
...
--
-- Dumping data for table `yk_customer`
--
...
(1, 0, 'anak', 'batam', 'anak@batam.com', '080989999', 'kepo x', '67d0b67f2232fe48f7f0e84a9a326338143cfd97', '85a176874', 'a:0:{}', '', 0, 1, 1, '::1', 1, 1, '', '2014-01-18 11:12:03'),
(2, 0, 'yogi', 'kortisa', 'yogi@kortisa.com', '84590', '', '1e13aa535ffdc0ff37c6bba3cb35703b12c6855f', 'b52506992', 'a:2:{s:4:"40::";i:1;s:4:"43::";i:1;}', '', 1, 2, 1, '::1', 1, 1, '', '2014-01-29 15:52:37');

-- --------------------------------------------------------

--
-- Table structure for table `yk_customer_ban_ip`
--
...
--
-- Table structure for table `yk_customer_field`
--
...
--
-- Table structure for table `yk_customer_group`
--
...
--
-- Dumping data for table `yk_customer_group`
--
...
--
-- Table structure for table `yk_customer_group_description`
--
...
--
-- Dumping data for table `yk_customer_group_description`
--
...
--
-- Table structure for table `yk_customer_history`
--
...
--
-- Table structure for table `yk_customer_ip`
--
...
--
-- Dumping data for table `yk_customer_ip`
--

INSERT INTO `yk_customer_ip` (`customer_ip_id`, `customer_id`, `ip`, `date_added`) VALUES
(1, 1, '::1', '2014-01-18 11:12:07'),
(2, 2, '127.0.0.1', '2014-01-29 15:52:40'),
(3, 2, '::1', '2014-01-29 16:02:41');

-- --------------------------------------------------------

--
-- Table structure for table `yk_customer_online`
--
...
--
-- Table structure for table `yk_customer_reward`
--
...
--
-- Table structure for table `yk_customer_transaction`
--
...
--
-- Table structure for table `yk_custom_field`
--
...
--
-- Table structure for table `yk_custom_field_description`
--
...
--
-- Table structure for table `yk_custom_field_to_customer_group`
--
...
--
-- Table structure for table `yk_custom_field_value`
--
...
--
-- Table structure for table `yk_custom_field_value_description`
--
...
--
-- Table structure for table `yk_download`
--
...
--
-- Table structure for table `yk_download_description`
--
...
--
-- Table structure for table `yk_extension`
--
...
--
-- Dumping data for table `yk_extension`
--
...
--
-- Table structure for table `yk_filter`
--
...
--
-- Table structure for table `yk_filter_description`
--
...
--
-- Table structure for table `yk_filter_group`
--
...
--
-- Table structure for table `yk_filter_group_description`
--
...
--
-- Table structure for table `yk_geo_zone`
--
...
--
-- Dumping data for table `yk_geo_zone`
--
...
--
-- Table structure for table `yk_information`
--
...
--
-- Dumping data for table `yk_information`
--
...
--
-- Table structure for table `yk_information_description`
--
...
--
-- Dumping data for table `yk_information_description`
--
...
--
-- Table structure for table `yk_information_to_layout`
--
...
--
-- Table structure for table `yk_information_to_store`
--
...
--
-- Dumping data for table `yk_information_to_store`
--
...
--
-- Table structure for table `yk_language`
--
...
--
-- Dumping data for table `yk_language`
--
...
(2, 'Indonesia', 'id', 'id_ID.UTF-8,id_ID,id-id,indonesia', 'id.png', 'indonesia', 'indonesia', 2, 0);

-- --------------------------------------------------------

--
-- Table structure for table `yk_layout`
--
...
--
-- Dumping data for table `yk_layout`
--
...
--
-- Table structure for table `yk_layout_route`
--
...
--
-- Dumping data for table `yk_layout_route`
--
...
--
-- Table structure for table `yk_length_class`
--
...
--
-- Dumping data for table `yk_length_class`
--
...
--
-- Table structure for table `yk_length_class_description`
--
...
--
-- Dumping data for table `yk_length_class_description`
--
...
--
-- Table structure for table `yk_manufacturer`
--
...
--
-- Dumping data for table `yk_manufacturer`
--
...
--
-- Table structure for table `yk_manufacturer_to_store`
--
...
--
-- Dumping data for table `yk_manufacturer_to_store`
--
...
--
-- Table structure for table `yk_option`
--
...
--
-- Dumping data for table `yk_option`
--
...
--
-- Table structure for table `yk_option_description`
--
...
--
-- Dumping data for table `yk_option_description`
--
...
--
-- Table structure for table `yk_option_value`
--
...
--
-- Dumping data for table `yk_option_value`
--

INSERT INTO `yk_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(32, 1, 'data/TEST/green.png', 1),
(45, 2, '', 4),
(44, 2, '', 3),
(41, 5, 'no_image.jpg', 3),
(42, 5, 'no_image.jpg', 4),
(31, 1, 'data/TEST/blue.png', 2),
(23, 2, '', 1),
(24, 2, '', 2),
(46, 11, '', 1),
(47, 11, '', 2),
(48, 11, '', 3),
(43, 1, 'data/TEST/red.png', 3),
(39, 5, 'no_image.jpg', 1),
(40, 5, 'no_image.jpg', 2);
...
--
-- Table structure for table `yk_option_value_description`
--
...
--
-- Dumping data for table `yk_option_value_description`
--
...
--
-- Table structure for table `yk_order`
--
...
--
-- Table structure for table `yk_order_download`
--
...
--
-- Table structure for table `yk_order_field`
--
...
--
-- Table structure for table `yk_order_fraud`
--
...
--
-- Table structure for table `yk_order_history`
--
...
--
-- Table structure for table `yk_order_option`
--
...
--
-- Table structure for table `yk_order_product`
--
...
--
-- Table structure for table `yk_order_recurring`
--
...
--
-- Table structure for table `yk_order_recurring_transaction`
--
...
--
-- Table structure for table `yk_order_status`
--
...
--
-- Dumping data for table `yk_order_status`
--
...
--
-- Table structure for table `yk_order_total`
--
...
--
-- Table structure for table `yk_order_voucher`
--
...
--
-- Table structure for table `yk_product`
--
...
--
-- Dumping data for table `yk_product`
--
...
(28, 'Product 1', '', '', '', '', '', '', '', 939, 7, 'data/demo/htc_touch_hd_1.jpg', 5, 1, 100.0000, 200, 9, '2009-02-03', 146.40000000, 2, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 1, '2009-02-03 16:06:50', '2011-09-30 01:05:39', 3),
...
(40, 'product 11', '', '', '', '', '', '', '', 970, 5, 'data/demo/iphone_1.jpg', 8, 1, 101.0000, 0, 9, '2009-02-03', 10.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 1, '2009-02-03 21:07:12', '2011-09-30 01:06:53', 16),
...
(42, 'Product 15', '', '', '', '', '', '', '', 990, 5, 'data/demo/apple_cinema_30.jpg', 8, 1, 100.0000, 400, 9, '2009-02-04', 12.50000000, 1, 1.00000000, 2.00000000, 3.00000000, 1, 1, 2, 0, 1, '2009-02-03 21:07:37', '2011-09-30 00:46:19', 81),
(43, 'Product 16', '', '', '', '', '', '', '', 929, 5, 'data/demo/macbook_1.jpg', 8, 0, 500.0000, 0, 9, '2009-02-03', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 2, 1, 1, 0, 1, '2009-02-03 21:07:49', '2011-09-30 01:05:46', 20),
...
(46, 'Product 19', '', '', '', '', '', '', '', 1000, 5, 'data/demo/sony_vaio_1.jpg', 10, 1, 1000.0000, 0, 9, '2009-02-03', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 2, 1, 1, 0, 1, '2009-02-03 21:08:29', '2011-09-30 01:06:39', 2),
...
(49, 'SAM1', '', '', '', '', '', '', '', 0, 8, 'data/demo/samsung_tab_1.jpg', 0, 1, 199.9900, 0, 9, '2011-04-25', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, '2011-04-26 08:57:34', '2011-09-30 01:06:23', 14),
(50, 'Adidass', '', '', '', '', '', '', '', 7, 5, 'data/TEST/red.png', 0, 1, 0.0000, 0, 0, '2014-01-01', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, '2014-01-02 01:35:59', '2014-01-02 02:11:29', 2);

-- --------------------------------------------------------

--
-- Table structure for table `yk_product_attribute`
--
...
--
-- Dumping data for table `yk_product_attribute`
--
...
--
-- Table structure for table `yk_product_description`
--
...
--
-- Dumping data for table `yk_product_description`
--
...
(30, 2, 'Canon EOS 5D', '&lt;p&gt;\r\n	Canon''s press material for the EOS 5D states that it ''defines (a) new D-SLR category'', while we''re not typically too concerned with marketing talk this particular statement is clearly pretty accurate. The EOS 5D is unlike any previous digital SLR in that it combines a full-frame (35 mm sized) high resolution sensor (12.8 megapixels) with a relatively compact body (slightly larger than the EOS 20D, although in your hand it feels noticeably ''chunkier''). The EOS 5D is aimed to slot in between the EOS 20D and the EOS-1D professional digital SLR''s, an important difference when compared to the latter is that the EOS 5D doesn''t have any environmental seals. While Canon don''t specifically refer to the EOS 5D as a ''professional'' digital SLR it will have obvious appeal to professionals who want a high quality digital SLR in a body lighter than the EOS-1D. It will also no doubt appeal to current EOS 20D owners (although lets hope they''ve not bought too many EF-S lenses...) äë&lt;/p&gt;\r\n', '', '', ''),
(50, 2, 'Kaos Keren', '&lt;p&gt;&lt;span style=&quot;font-size: 13px;&quot;&gt;Ini kaso keren banget dan juga murah.&lt;/span&gt;&lt;/p&gt;\r\n', 'Kaos Keren, T-Shirt', 'Kaos Keren, T-Shirt', 'kaos'),
(50, 1, 'Good T-Shirt', '&lt;p&gt;This is a good T-shirt and very cheap for you.&lt;/p&gt;\r\n', 'very good t-shirt', 'good t-shit, t-shirt', 't-shirt');

-- --------------------------------------------------------

--
-- Table structure for table `yk_product_discount`
--
...
--
-- Dumping data for table `yk_product_discount`
--
...
--
-- Table structure for table `yk_product_filter`
--
...
--
-- Table structure for table `yk_product_image`
--
...
--
-- Dumping data for table `yk_product_image`
--
...
(2357, 50, 'data/green.png', 0),
(2356, 50, 'data/TEST/blue.png', 0);

-- --------------------------------------------------------

--
-- Table structure for table `yk_product_option`
--
...
--
-- Dumping data for table `yk_product_option`
--
...
--
-- Table structure for table `yk_product_option_value`
--
...
--
-- Dumping data for table `yk_product_option_value`
--
...
(17, 227, 50, 1, 43, 0, 1, 0.0000, '+', 0, '+', 0.00000000, '+'),
(18, 227, 50, 1, 32, 0, 1, 0.0000, '+', 0, '+', 0.00000000, '+'),
(19, 227, 50, 1, 31, 0, 1, 0.0000, '+', 0, '+', 0.00000000, '+'),
(20, 228, 50, 5, 39, 0, 1, 70000.0000, '+', 0, '+', 0.00000000, '+'),
(21, 228, 50, 5, 40, 3, 1, 85000.0000, '+', 0, '+', 0.00000000, '+');

-- --------------------------------------------------------

--
-- Table structure for table `yk_product_profile`
--

CREATE TABLE IF NOT EXISTS `yk_product_profile` (
  `product_id` int(11) NOT NULL,
  `profile_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- Table structure for table `yk_product_recurring`
--
...
--
-- Table structure for table `yk_product_related`
--
...
--
-- Dumping data for table `yk_product_related`
--
...
--
-- Table structure for table `yk_product_reward`
--
...
--
-- Dumping data for table `yk_product_reward`
--
...
--
-- Table structure for table `yk_product_special`
--
...
--
-- Dumping data for table `yk_product_special`
--
...
--
-- Table structure for table `yk_product_to_category`
--
...
--
-- Dumping data for table `yk_product_to_category`
--
...
--
-- Table structure for table `yk_product_to_download`
--
...
--
-- Table structure for table `yk_product_to_layout`
--
...
--
-- Dumping data for table `yk_product_to_layout`
--
...
--
-- Table structure for table `yk_product_to_store`
--
...
--
-- Dumping data for table `yk_product_to_store`
--
...
--
-- Table structure for table `yk_profile`
--

CREATE TABLE IF NOT EXISTS `yk_profile` (
...
--
-- Table structure for table `yk_profile_description`
--

CREATE TABLE IF NOT EXISTS `yk_profile_description` (
  `profile_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `yk_return`
--
...
--
-- Table structure for table `yk_return_action`
--
...
--
-- Dumping data for table `yk_return_action`
--
...
--
-- Table structure for table `yk_return_history`
--
...
--
-- Table structure for table `yk_return_reason`
--
...
--
-- Dumping data for table `yk_return_reason`
--
...
--
-- Table structure for table `yk_return_status`
--
...
--
-- Dumping data for table `yk_return_status`
--
...
--
-- Table structure for table `yk_review`
--
...
--
-- Table structure for table `yk_setting`
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1962 ;

--
-- Dumping data for table `yk_setting`
--
...
(1943, 0, 'config', 'config_google_analytics', '', 0),
(1942, 0, 'config', 'config_error_filename', 'error.txt', 0),
...
(1960, 0, 'featured', 'featured_product', '43,40,42,49,46,47,28', 0),
(1961, 0, 'featured', 'featured_module', 'a:1:{i:0;a:7:{s:5:"limit";s:2:"12";s:11:"image_width";s:3:"320";s:12:"image_height";s:3:"420";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"2";}}', 1),
...
(1940, 0, 'config', 'config_error_display', '1', 0),
(1933, 0, 'config', 'config_seo_url', '0', 0),
(1934, 0, 'config', 'config_file_extension_allowed', 'txt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc\r\nrtf\r\nxls\r\nppt\r\nodt\r\nods', 0),
(1935, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/jpeg\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/vnd.microsoft.icon\r\nimage/tiff\r\nimage/tiff\r\nimage/svg+xml\r\nimage/svg+xml\r\napplication/zip\r\napplication/x-rar-compressed\r\napplication/x-msdownload\r\napplication/vnd.ms-cab-compressed\r\naudio/mpeg\r\nvideo/quicktime\r\nvideo/quicktime\r\napplication/pdf\r\nimage/vnd.adobe.photoshop\r\napplication/postscript\r\napplication/postscript\r\napplication/postscript\r\napplication/msword\r\napplication/rtf\r\napplication/vnd.ms-excel\r\napplication/vnd.ms-powerpoint\r\napplication/vnd.oasis.opendocument.text\r\napplication/vnd.oasis.opendocument.spreadsheet', 0),
(1936, 0, 'config', 'config_maintenance', '0', 0),
(1937, 0, 'config', 'config_password', '1', 0),
(1938, 0, 'config', 'config_encryption', 'a24775e272a387b0190f1f86e1ac2cb8', 0),
(1939, 0, 'config', 'config_compression', '0', 0),
(1932, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(94, 0, 'voucher', 'voucher_sort_order', '8', 0),
(95, 0, 'voucher', 'voucher_status', '1', 0),
(103, 0, 'free_checkout', 'free_checkout_status', '1', 0),
(104, 0, 'free_checkout', 'free_checkout_order_status_id', '1', 0),
(344, 0, 'slideshow', 'slideshow_module', 'a:1:{i:0;a:7:{s:9:"banner_id";s:1:"7";s:5:"width";s:3:"980";s:6:"height";s:3:"280";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"1";}}', 1),
...
(1931, 0, 'config', 'config_shared', '0', 0),
(1930, 0, 'config', 'config_secure', '0', 0),
(1929, 0, 'config', 'config_fraud_status_id', '7', 0),
(1928, 0, 'config', 'config_fraud_score', '', 0),
(1927, 0, 'config', 'config_fraud_key', '', 0),
(1926, 0, 'config', 'config_fraud_detection', '0', 0),
(1925, 0, 'config', 'config_alert_emails', '', 0),
(1924, 0, 'config', 'config_account_mail', '0', 0),
(1923, 0, 'config', 'config_alert_mail', '0', 0),
(1922, 0, 'config', 'config_smtp_timeout', '5', 0),
(1921, 0, 'config', 'config_smtp_port', '25', 0),
(1920, 0, 'config', 'config_smtp_password', '', 0),
(1919, 0, 'config', 'config_smtp_username', '', 0),
(1918, 0, 'config', 'config_smtp_host', '', 0),
(1917, 0, 'config', 'config_mail_parameter', '', 0),
(1916, 0, 'config', 'config_mail_protocol', 'mail', 0),
(1915, 0, 'config', 'config_ftp_status', '0', 0),
(1914, 0, 'config', 'config_ftp_root', '', 0),
(1913, 0, 'config', 'config_ftp_password', '', 0),
(1912, 0, 'config', 'config_ftp_username', '', 0),
(1911, 0, 'config', 'config_ftp_port', '21', 0),
(1910, 0, 'config', 'config_ftp_host', 'localhost', 0),
(1909, 0, 'config', 'config_image_cart_height', '47', 0),
(1908, 0, 'config', 'config_image_cart_width', '47', 0),
(1907, 0, 'config', 'config_image_wishlist_height', '47', 0),
(1906, 0, 'config', 'config_image_wishlist_width', '47', 0),
(1905, 0, 'config', 'config_image_compare_height', '90', 0),
(1904, 0, 'config', 'config_image_compare_width', '90', 0),
(1903, 0, 'config', 'config_image_related_height', '80', 0),
(1902, 0, 'config', 'config_image_related_width', '80', 0),
(1901, 0, 'config', 'config_image_additional_height', '74', 0),
(1900, 0, 'config', 'config_image_additional_width', '74', 0),
(1899, 0, 'config', 'config_image_product_height', '80', 0),
(1898, 0, 'config', 'config_image_product_width', '80', 0),
(1897, 0, 'config', 'config_image_popup_height', '500', 0),
(1896, 0, 'config', 'config_image_popup_width', '500', 0),
(1895, 0, 'config', 'config_image_thumb_height', '628', 0),
(1894, 0, 'config', 'config_image_thumb_width', '628', 0),
(1893, 0, 'config', 'config_image_category_height', '80', 0),
(1892, 0, 'config', 'config_image_category_width', '80', 0),
(1891, 0, 'config', 'config_icon', 'data/cart.png', 0),
(1890, 0, 'config', 'config_logo', 'data/logo.png', 0),
(1889, 0, 'config', 'config_return_status_id', '2', 0),
(1888, 0, 'config', 'config_return_id', '0', 0),
(1887, 0, 'config', 'config_commission', '5', 0),
(1886, 0, 'config', 'config_affiliate_id', '4', 0),
(1885, 0, 'config', 'config_stock_status_id', '5', 0),
(1884, 0, 'config', 'config_stock_checkout', '0', 0),
(1883, 0, 'config', 'config_stock_warning', '0', 0),
(1882, 0, 'config', 'config_stock_display', '0', 0),
(1881, 0, 'config', 'config_complete_status_id', '5', 0),
(1880, 0, 'config', 'config_order_status_id', '1', 0),
(1879, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(1878, 0, 'config', 'config_order_edit', '100', 0),
(1877, 0, 'config', 'config_checkout_id', '5', 0),
(1876, 0, 'config', 'config_guest_checkout', '1', 0),
(1875, 0, 'config', 'config_cart_weight', '1', 0),
(1874, 0, 'config', 'config_account_id', '3', 0),
(1871, 0, 'config', 'config_customer_group_id', '1', 0),
(1872, 0, 'config', 'config_customer_group_display', 'a:1:{i:0;s:1:"1";}', 1),
(1873, 0, 'config', 'config_customer_price', '0', 0),
(1870, 0, 'config', 'config_customer_online', '0', 0),
(1869, 0, 'config', 'config_tax_customer', 'shipping', 0),
(1868, 0, 'config', 'config_tax_default', 'shipping', 0),
(1867, 0, 'config', 'config_vat', '0', 0),
(1866, 0, 'config', 'config_tax', '1', 0),
(1865, 0, 'config', 'config_voucher_max', '1000', 0),
(1864, 0, 'config', 'config_voucher_min', '1', 0),
(1863, 0, 'config', 'config_download', '1', 0),
(1862, 0, 'config', 'config_review_status', '1', 0),
(1861, 0, 'config', 'config_product_count', '1', 0),
(1860, 0, 'config', 'config_admin_limit', '20', 0),
(1859, 0, 'config', 'config_catalog_limit', '15', 0),
(1858, 0, 'config', 'config_weight_class_id', '1', 0),
(1857, 0, 'config', 'config_length_class_id', '1', 0),
(1856, 0, 'config', 'config_currency_auto', '1', 0),
(1855, 0, 'config', 'config_currency', 'IDR', 0),
(1854, 0, 'config', 'config_admin_language', 'en', 0),
(1853, 0, 'config', 'config_language', 'en', 0),
(1852, 0, 'config', 'config_zone_id', '1529', 0),
(1851, 0, 'config', 'config_country_id', '100', 0),
(1850, 0, 'config', 'config_layout_id', '4', 0),
(1849, 0, 'config', 'config_template', 'default', 0),
(1847, 0, 'config', 'config_title', 'Adam Eve', 0),
(1848, 0, 'config', 'config_meta_description', 'Adam Eve Store | Toko Online Adam Eve', 0),
(1846, 0, 'config', 'config_fax', '', 0),
(1845, 0, 'config', 'config_telephone', '123456789', 0),
(1844, 0, 'config', 'config_email', 'admin@opencart.com', 0),
(1843, 0, 'config', 'config_address', 'Batam, Kepulauan Riau, Indonesia.', 0),
(1842, 0, 'config', 'config_owner', 'Zhafran', 0),
(1841, 0, 'config', 'config_name', 'Adam Eve', 0);

-- --------------------------------------------------------

--
-- Table structure for table `yk_stock_status`
--
...
--
-- Dumping data for table `yk_stock_status`
--
...
--
-- Table structure for table `yk_store`
--
...
--
-- Table structure for table `yk_tax_class`
--
...
--
-- Dumping data for table `yk_tax_class`
--
...
--
-- Table structure for table `yk_tax_rate`
--
...
--
-- Dumping data for table `yk_tax_rate`
--
...
--
-- Table structure for table `yk_tax_rate_to_customer_group`
--
...
--
-- Dumping data for table `yk_tax_rate_to_customer_group`
--
...
--
-- Table structure for table `yk_tax_rule`
--
...
--
-- Dumping data for table `yk_tax_rule`
--
...
--
-- Table structure for table `yk_url_alias`
--
...
--
-- Dumping data for table `yk_url_alias`
--
...
(1, 1, 'admin', 'e8cdfbb70108900f262ee10d182df84e508210c2', 'f04a633f3', '', '', 'admin@opencart.com', '', '127.0.0.1', 1, '2014-01-01 13:41:06');
...
--
-- Table structure for table `yk_voucher_history`
--
...
--
-- Table structure for table `yk_voucher_theme`
--
...
--
-- Dumping data for table `yk_voucher_theme`
--
...
--
-- Table structure for table `yk_voucher_theme_description`
--
...
--
-- Dumping data for table `yk_voucher_theme_description`
--
...
--
-- Table structure for table `yk_weight_class`
--
...
--
-- Dumping data for table `yk_weight_class`
--
...
--
-- Table structure for table `yk_weight_class_description`
--
...
--
-- Dumping data for table `yk_weight_class_description`
--
...
--
-- Table structure for table `yk_zone`
--
...
--
-- Dumping data for table `yk_zone`
--
...
--
-- Table structure for table `yk_zone_to_geo_zone`
--
...
--
-- Dumping data for table `yk_zone_to_geo_zone`
--
