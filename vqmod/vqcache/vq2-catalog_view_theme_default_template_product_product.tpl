...
<div id="content"><?php echo $content_top; ?>
  ...
  <h1><center><?php echo $heading_title; ?></h1></center>
  <div class="product-info"><hr />
    <?php if ($thumb || $images) { ?>
    <div class="left">
      
	<?php if ($thumb) { ?>
	<div class="image"><a href="<?php echo $zoom_image; ?>" title="<?php echo $heading_title; ?>" class="cloud-zoom" id='zoom1' rel="adjustX: 10, adjustY:-4, tint:'#000000',tintOpacity:0.2, zoomWidth:660"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a></div>   
